    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {!detail && !deudaSnapshot && !redVial ? (
        ...
        <div className="space-y-8">
          ...
          {/* Red vial estimada (OSM) — Sprint 30 / Pilar 5 */}
          {redVial && (
            <section>
              <div className="mb-4 flex flex-wrap items-baseline justify-between gap-2">
              ...
              <p className="mb-4 text-xs text-muted-foreground max-w-3xl">
                Kilómetros de carreteras en el partido derivados de
                OpenStreetMap. Útil como denominador para mantenimiento vial
                per km. Cobertura OSM heterogénea entre partidos —
                interpretar como orden de magnitud, no precisión catastral.
              </p>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-4">
